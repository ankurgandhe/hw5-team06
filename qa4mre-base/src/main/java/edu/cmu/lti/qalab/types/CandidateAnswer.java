...
public class CandidateAnswer extends Annotation {
  ...
  //*--------------*
  //* Feature: tokenSimilarityScore

  /** getter for tokenSimilarityScore - gets 
   * @generated */
  public double getTokenSimilarityScore() {
    if (CandidateAnswer_Type.featOkTst && ((CandidateAnswer_Type)jcasType).casFeat_tokenSimilarityScore == null)
      jcasType.jcas.throwFeatMissing("tokenSimilarityScore", "edu.cmu.lti.qalab.types.CandidateAnswer");
    return jcasType.ll_cas.ll_getDoubleValue(addr, ((CandidateAnswer_Type)jcasType).casFeatCode_tokenSimilarityScore);}
    
  /** setter for tokenSimilarityScore - sets  
   * @generated */
  public void setTokenSimilarityScore(double v) {
    if (CandidateAnswer_Type.featOkTst && ((CandidateAnswer_Type)jcasType).casFeat_tokenSimilarityScore == null)
      jcasType.jcas.throwFeatMissing("tokenSimilarityScore", "edu.cmu.lti.qalab.types.CandidateAnswer");
    jcasType.ll_cas.ll_setDoubleValue(addr, ((CandidateAnswer_Type)jcasType).casFeatCode_tokenSimilarityScore, v);}    
  }
