...
/* First created by JCasGen Wed Dec 04 18:47:18 EST 2013 */
...
/** 
 * Updated by JCasGen Thu Dec 05 09:48:39 EST 2013
 * @generated */
public class CandidateAnswer_Type extends Annotation_Type {
  ...
  /** @generated */
  final Feature casFeat_tokenSimilarityScore;
  /** @generated */
  final int     casFeatCode_tokenSimilarityScore;
  /** @generated */ 
  public double getTokenSimilarityScore(int addr) {
        if (featOkTst && casFeat_tokenSimilarityScore == null)
      jcas.throwFeatMissing("tokenSimilarityScore", "edu.cmu.lti.qalab.types.CandidateAnswer");
    return ll_cas.ll_getDoubleValue(addr, casFeatCode_tokenSimilarityScore);
  }
  /** @generated */    
  public void setTokenSimilarityScore(int addr, double v) {
        if (featOkTst && casFeat_tokenSimilarityScore == null)
      jcas.throwFeatMissing("tokenSimilarityScore", "edu.cmu.lti.qalab.types.CandidateAnswer");
    ll_cas.ll_setDoubleValue(addr, casFeatCode_tokenSimilarityScore, v);}
  ...
  public CandidateAnswer_Type(JCas jcas, Type casType) {
    ...
    casFeat_tokenSimilarityScore = jcas.getRequiredFeatureDE(casType, "tokenSimilarityScore", "uima.cas.Double", featOkTst);
    casFeatCode_tokenSimilarityScore  = (null == casFeat_tokenSimilarityScore) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl)casFeat_tokenSimilarityScore).getCode();
